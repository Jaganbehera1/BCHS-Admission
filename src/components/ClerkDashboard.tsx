...
import { FileText, Printer, Eye, LogOut } from 'lucide-react';
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p><strong>Name:</strong> {selectedApp.student_name}</p>
                  <p><strong>Aadhaar:</strong> {selectedApp.aadhaar_no}</p>
                  ...
                  <p><strong>PWD:</strong> {selectedApp.is_pwd ? 'Yes' : 'No'}</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Parent Information</h4>
                  <p><strong>Father:</strong> {selectedApp.father_name}</p>
                  <p><strong>Mother:</strong> {selectedApp.mother_name}</p>
